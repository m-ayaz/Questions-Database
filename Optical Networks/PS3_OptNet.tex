...
\item
Determine the numerical aperture (NA) for a fiber with a core refractive index of $1.500$ and a cladding refractive index of $1.495$.
\item
...
$
 at $0.8 \mu m$. Calculate the dispersion $\beta_2$ and $D$.
\nl
%\nl
\Q
...
Non-Linear Shr\o dinger equation
 ...
 with $\gamma=0$:
$$
{\partial A\over \partial z}+{\alpha\over 2}A+j{\beta_2\over 2}\cdot{\partial^2 A\over \partial t^2}=0
$$

\begin{enumerate}[label=\alph*.]
\item
Show that the general solution in frequency domain to this differential equation is
$$
...
Considering the previous question where $\gamma=0$ is assumed and the fiber length is $L$.
\begin{enumerate}[label=\alph*.]
\item
Find the output of the optical fiber when the input is the chirped Gaussian signal given in part b of question 3 by using the general solution of part a. Show that the output is also Gaussian.

\item
Find $1\over e$-intensity spectral half width $\Delta \omega_0$ for the output Gaussian signal.
%
%\item
