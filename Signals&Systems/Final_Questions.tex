...
مقدار 
$
{1\over 2\pi}\int_{0}^{2\pi} \left|{dX(e^{j\omega})\over d\omega}\right|^2 d\omega
$
...
\end{cases}
$$
خطی و تغییر ناپذیر با زمان هریک از این سیستم ها را با بیان استدلال کافی تعیین کنید.
%%%%%%%%%%%%%%%%%%%%%%
...
در این صورت، سیگنال $x[n]$ را بیابید.
%}
%{$\delta[n]-\delta[n-1]$}
