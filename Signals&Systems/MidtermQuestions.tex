...
سوالات تستی + تشریحی میان ترم درس تجزیه و تحلیل سیستم ها

استاد درس: دکتر بیگی

زمان امتحان: 90 دقیقه
\hl
\end{center}
...
\begin{figure}[h!]
\centering
\includegraphics[width=70mm]{m_2Q.eps}
\end{figure}
...
s(t)
$
 را بر حسب $\alpha_k$ بیابید.
\nl
\Q

سیگنال $x(t)$ را که دارای تبدیل فوریه‌ای با اندازه و فاز زیر است، بیابید.
\begin{figure}[h!]
\centering
\begin{subfigure}{0.49\textwidth}
\includegraphics[width=80mm]{_21Q_ab.eps}
...
b_k
$
است. دوره‌ی تناوب و ضرایب سری فوریه‌ی 
$
y(t)=x_1(t)+x_2(t)
$
 را بیابید.
